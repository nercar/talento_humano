...
@section('content')
	...
	<div class="container-fluid p-1 contenido bg-light" id="eval1" style="overflow-y: scroll">
		<table width="75%" 
			...
			@foreach ($respuestas as $respuesta)
				...
				@if($respuesta->id_pregunta==1)
					...
					<tr>
						<td colspan="3"></td>
						<td colspan="1" class="text-dark text-right"><b>Si</b>&nbsp;</td>
						<td colspan="1" class="optiontdd">@if($respuesta->respuesta == 1) &#10004; @endif</td>
						<td colspan="1" class="text-dark">&nbsp;Continúa</td>
						<td colspan="4"></td>
						<td colspan="1" class="text-dark text-right"><b>No</b>&nbsp;</td>
						<td colspan="1" class="optiontdd">@if($respuesta->respuesta == 0) &#10004; @endif</td>
						<td colspan="1" class="text-dark">&nbsp;Fin</td>
						<td colspan="3"></td>
					</tr>
				@endif
				@if($respuesta->id_pregunta==2)
					...
					<tr>
						<td colspan="1"></td>
						<td colspan="15">
							<textarea id="prg2" rows="2" readonly 
