	...
	<div class="container-fluid col-lg-12 col-md-12 col-12 text-light bg-dark border border-info">
		<table class="w-100">
			<tr>
				...
				<td width = "46%" class="border-0 p-0 m-0 text-center">
		...
		<table id="list" class="table table-striped table-hover w-100">
			@foreach ($cursos as $curso)
				<tr id="r{{ $curso->id }}"
					...
					<td width = "6%" style="text-align: right; font-size: 18px;"
						class="border border-primary border-top-0 border-left-0 border-right-0">
						<a href="/participantesevaluados/{{ $curso->id }}"	id="evaluados">
							<i class="fas fa-user-check fa-lg img_btn"
								title="Participantes Evaluados"></i></a>
					</td>
				</tr>
			@endforeach
		</table>
